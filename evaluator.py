...
def compute_cm(classifier, test_data):
    ...
    Returns:
        Confusion matrix
    """
    confusion_matrix = ConfusionMatrix(classifier.label2index, classifier.index2label)
...
class ConfusionMatrix(object):
    ...
    def __init__(self, label2index, index2label):
        """
        ...
        self.label_codebook = label2index
        self.index2label = index2label
        self.num_classes = len(label2index)
