...
class POSCorpus(Corpus):
    """
    NP Chunking dataset from wsj. each document is one sentence, each sentence is a list of postags.
    """
...
class WordCorpus(Corpus):
    """
    NP Chunking dataset from wsj. each document is one sentence, each sentence is a list of words.
    """
